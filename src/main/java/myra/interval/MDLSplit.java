 ...
 */
public class MDLSplit extends EntropySplit {
    /**
     * The interval builder responsible to generate candidate intervals.
     */
    private EntropySplit builder;
    ...
    /**
     * Creates a new <code>MDLInterval</code> using the {@link C45Split} as the
     * interval builder.
     */
    public MDLSplit() {
	this(new C45Split());
     ...
     */
    public MDLSplit(EntropySplit builder) {
	this(builder, true);
    }
     ...
     */
    public MDLSplit(EntropySplit builder, boolean strict) {

/*
 * UnorderedPittsburghContinuousAntMiner.java
...
import static myra.classification.rule.unordered.ConflictResolution.CONFIDENCE;
import static myra.classification.rule.unordered.FindRuleSetActivity.DYNAMIC_FUNCTION;
...
import myra.classification.rule.unordered.FindRuleSetActivity;
import myra.classification.rule.unordered.attribute.BinaryMDLSplit;
import myra.classification.rule.unordered.attribute.BoundaryLaplaceSplit;
 ...
 */
public class UnorderedPittsburghContinuousAntMiner extends RuleClassifier {
    @Override
    protected void defaults() {
        ...
        CONFIG.set(DEFAULT_MEASURE, new ListAccuracy());
    ...
    protected Collection<Option<?>> options() {
        ...
        // rule pruner
        Option<Pruner> pruner = new Option<>(DEFAULT_PRUNER,
                                             "p",
        ...
        Option<Heuristic> heuristic = new Option<>(DEFAULT_HEURISTIC,
                                                   "h",
        ...
        // dynamic function selector
        Option<ConflictResolution> conflict =
                new Option<>(CONFLICT_RESOLUTION,
                             "-conflict",
    ...
    public static void main(String[] args) throws Exception {
        UnorderedPittsburghContinuousAntMiner algorithm =
                new UnorderedPittsburghContinuousAntMiner();
        algorithm.run(args);
    }
}
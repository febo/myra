...
import static myra.Attribute.ANY_OF;
import static myra.Attribute.EQUAL_TO;
import static myra.Attribute.GREATER_THAN;
import static myra.Attribute.GREATER_THAN_OR_EQUAL_TO;
import static myra.Attribute.IN_RANGE;
import static myra.Attribute.LESS_THAN;
...
public class Parser {
	...
	private static void parse(String output, String dataset)
		...
		if (line.contains("File stem")) {
		    ...
		    values.add(Parser.average(test, list));
	...
	private static void parse(String output, String dataset)
		...
		if (line.contains("Reading file")) {
		    ...
		    values.add(Parser.average(test, set));
	...
	private static double parse(String output, String dataset)
		...
		if (isList && line.contains("<empty>")) {
		    ...
		    total += Parser.average(test, list);
		    count++;

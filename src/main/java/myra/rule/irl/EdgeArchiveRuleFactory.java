 ...
 * @author amh58
 */
public class EdgeArchiveRuleFactory implements RuleFactory {
    /**
	...
	return this.create((Graph) graph, heuristic, dataset, instances);
    }
	...
	// the rule being created (empty at the start)
		...
		while (true) {
		    ...
		    Term term = new Term(selected, vertex.condition(0));
		    rule.push(term);
